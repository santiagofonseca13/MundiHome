...
import com.mh.mundihome.databinding.ActivitySeleccionarUbicacionBinding
...
class SeleccionarUbicacion : AppCompatActivity() , OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Places.initialize(this, getString(R.string.mi_google_api_key))
        ...
        binding.IbGsp.setOnClickListener {
            if (esGpsActivado()){
                ...
                Toast.makeText(this, "!La ubicación no esta activada¡. Activalo para mostrar la ubicación actual", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun direccionLatitudLng(latlng: LatLng) {
